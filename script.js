...
const GIST_ID = 'eb389df4b783de44f1521e4a305d63ca';
...
const targetDate2026 = new Date('2026-08-03T00:00:00');
const targetDate2027 = new Date('2027-08-02T00:00:00');
...
function showBatchToast(batch) {
  ...
  let targetDate;
  switch(batch) {
    case '2025': targetDate = targetDate2025; break;
    case '2026': targetDate = targetDate2026; break;
    case '2027': targetDate = targetDate2027; break;
    case 'ol': targetDate = targetDateOL; break;
  }
...
function updateCountdown() {
  ...
  batches.forEach(batch => {
    ...
    const daysPassedElem = document.getElementById(`daysPassed${batch.year}`);
    if (daysPassedElem) {
...
async function loadComments() {
  try {
    ...
    // Use fallback comments if Gist fails
    comments = [
      {
        id: 1,
        author: "සදීප",
